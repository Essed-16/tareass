##Ejercicio numero 6: Desarrollar un programa que calcule el promedio (debe ingresar 3 notas) de un alumno para evaluar su rendimiento (Malo 0-10, Regular 11-13, Bueno 14- 17, Excelente 18-20) 
